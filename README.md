...
## Versão 1.0.1 — Área do gestor

As páginas **Central do Gestor** e **Gestão da Equipe** agora exigem senha.

- A senha é comparada por SHA-256.
- A autorização fica no `sessionStorage`.
- Atualizar a página mantém a sessão.
- Fechar a aba ou usar **Sair do gestor** bloqueia novamente as áreas.
- A proteção em GitHub Pages impede acesso casual, mas não substitui autenticação real em servidor para dados altamente sensíveis.
